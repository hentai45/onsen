...
000000c6 <memcopy>:
  ...
  c9:	56                   	push   %esi
  ca:	89 ce                	mov    %ecx,%esi
  cc:	53                   	push   %ebx
  cd:	31 db                	xor    %ebx,%ebx
  cf:	39 f3                	cmp    %esi,%ebx
  d1:	7d 09                	jge    dc <memcopy+0x16>
  d3:	8a 0c 1a             	mov    (%edx,%ebx,1),%cl
  d6:	88 0c 18             	mov    %cl,(%eax,%ebx,1)
  d9:	43                   	inc    %ebx
  da:	eb f3                	jmp    cf <memcopy+0x9>
  dc:	5b                   	pop    %ebx
  dd:	5e                   	pop    %esi
  de:	5d                   	pop    %ebp
  df:	c3                   	ret    
