...
0000000d <enable_a20>:
  ...
  13:	e8 fc ff ff ff       	call   14 <enable_a20+0x7>
  18:	b0 d1                	mov    $0xd1,%al
  1a:	e6 64                	out    %al,$0x64
  1c:	e8 fc ff ff ff       	call   1d <enable_a20+0x10>
  21:	b0 df                	mov    $0xdf,%al
  23:	e6 60                	out    %al,$0x60
  25:	c9                   	leave  
  26:	e9 fc ff ff ff       	jmp    27 <enable_a20+0x1a>

0000002b <wait_kbc_sendready>:
  2b:	55                   	push   %ebp
  2c:	89 e5                	mov    %esp,%ebp
  2e:	e4 64                	in     $0x64,%al
  30:	a8 02                	test   $0x2,%al
  32:	75 fa                	jne    2e <wait_kbc_sendready+0x3>
  34:	5d                   	pop    %ebp
  35:	c3                   	ret    

00000036 <move_disk_data>:
  36:	55                   	push   %ebp
  37:	b9 00 02 00 00       	mov    $0x200,%ecx
  3c:	89 e5                	mov    %esp,%ebp
  3e:	ba 00 7c 00 00       	mov    $0x7c00,%edx
  43:	83 ec 08             	sub    $0x8,%esp
  46:	b8 00 00 10 00       	mov    $0x100000,%eax
  4b:	e8 56 00 00 00       	call   a6 <memcopy>
  50:	b9 00 f8 0a 00       	mov    $0xaf800,%ecx
  55:	ba 00 82 00 00       	mov    $0x8200,%edx
  5a:	b8 00 02 10 00       	mov    $0x100200,%eax
  5f:	c9                   	leave  
  60:	eb 44                	jmp    a6 <memcopy>

00000062 <move_and_run_onsensys>:
  62:	55                   	push   %ebp
  63:	b9 00 00 08 00       	mov    $0x80000,%ecx
  68:	89 e5                	mov    %esp,%ebp
  6a:	ba 00 00 00 00       	mov    $0x0,%edx
  6f:	83 ec 08             	sub    $0x8,%esp
  72:	b8 00 00 28 00       	mov    $0x280000,%eax
  77:	e8 2a 00 00 00       	call   a6 <memcopy>
  7c:	8b 0d 10 00 00 00    	mov    0x10,%ecx
  82:	85 c9                	test   %ecx,%ecx
  84:	74 10                	je     96 <move_and_run_onsensys+0x34>
  86:	8b 15 14 00 00 00    	mov    0x14,%edx
  8c:	a1 0c 00 00 00       	mov    0xc,%eax
  91:	e8 10 00 00 00       	call   a6 <memcopy>
  96:	a1 0c 00 00 00       	mov    0xc,%eax
  9b:	89 c4                	mov    %eax,%esp
  9d:	ea 1b 00 28 00 10 00 	ljmp   $0x10,$0x28001b
  a4:	c9                   	leave  
  a5:	c3                   	ret    
...
000000a6 <memcopy>:
  ...
  a9:	56                   	push   %esi
  aa:	89 ce                	mov    %ecx,%esi
  ac:	53                   	push   %ebx
  ad:	31 db                	xor    %ebx,%ebx
  af:	39 f3                	cmp    %esi,%ebx
  b1:	7d 09                	jge    bc <memcopy+0x16>
  b3:	8a 0c 1a             	mov    (%edx,%ebx,1),%cl
  b6:	88 0c 18             	mov    %cl,(%eax,%ebx,1)
  b9:	43                   	inc    %ebx
  ba:	eb f3                	jmp    af <memcopy+0x9>
  bc:	5b                   	pop    %ebx
  bd:	5e                   	pop    %esi
  be:	5d                   	pop    %ebp
  bf:	c3                   	ret    
